...
//init the needed arrays note that arrayC is used for local sumation only
...
int main(int argc, char* argv[])
{
	...
	if (rank == 0) {
		//file io junk
		auto f = fopen("AndrewNashParallelH2.txt", "w");
		if (f == nullptr)
		{
			printf("Error opening file!\n");
			return 0;
		}
		//temp value holder for unitialized array
		int temp = 0;
